...
class NPCClass:
    ...
    def create_npcs(self, number_of_vehicles=150, number_of_walkers=70):
        ...
        # These guy has a wonky movement [physics broken?]
        ...
        vehicle_actors = world.get_actors(self.vehicles_list)
        self.non_players.extend(vehicle_actors)
        ...
        walkers_id = []
        for i in range(len(self.walkers_list)):
            walkers_id.append(self.walkers_list[i]["id"])
        walker_actors = world.get_actors(walkers_id)
        self.non_players.extend(walker_actors)
        ...
        return self.vehicles_list, self.walkers_list, self.non_players
